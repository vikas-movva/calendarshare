...
export default function ThemeControls({
  ...
  useEffect(() => {
    ...
    const onPointerDown = (e: PointerEvent) => {
      const ref = (document.getElementById('accent-popover'))
  ...
  return (
    <div className={variant === 'mobile' ? 'flex items-center gap-3' : 'flex items-center gap-2'}>
      <motion.button
        type="button"
        onClick={toggleMode}
              ...
              <div className="grid grid-cols-5 gap-2">
                {themeOrder.map((name: ThemeName) => {
                  ...
                  return (
                    ...
                    >
                      {active && (
                        <svg className="w-3.5 h-3.5 text-on-accent drop-shadow" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
